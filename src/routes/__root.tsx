    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-full gradient-primary px-5 py-2 text-sm font-medium text-primary-foreground shadow-glow transition-transform hover:-translate-y-0.5"
          >
            Go home
          </Link>
        </div>
      ...
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-full gradient-primary px-5 py-2 text-sm font-medium text-primary-foreground shadow-glow"
          >
            Try again
          </button>
          <a
  ...
  head: () => ({
    meta: [
      ...
      { title: "Nimbus AI — Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Nimbus AI helps professionals draft emails, summarize meetings, plan tasks, and research topics — powered by a premium AI workspace.",
      },
      { name: "author", content: "Nimbus AI" },
      { property: "og:title", content: "Nimbus AI — Workplace Productivity Assistant" },
      {
        property: "og:description",
        content: "Automate everyday workplace tasks with an elegant, purple-themed AI workspace.",
      },
